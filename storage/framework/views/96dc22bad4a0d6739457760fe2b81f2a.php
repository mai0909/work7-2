...
<body>
    <div class="cost">
        ...
        <form action="<?php echo e(route('buy-complete')); ?>" class="cost-form">
        <?php echo csrf_field(); ?> 
            <div class="toilet cost-content">
                <p>＜トイレの改装費用＞</p>
                <div class="cost-select">
                    <div class="img-select">
                        <img src="<?php echo e(asset('storage/image/free.jpg')); ?>">
                        <input type="radio" name="toilet" value="0">0円
                    </div>
                    <div class="img-select">
                        <img src="<?php echo e(asset('storage/image/toilet1.jpg')); ?>">
                        <input type="radio" name="toilet" value="15">15万円
                    </div>
                    <div class="img-select">
                        <img src="<?php echo e(asset('storage/image/toilet2.jpg')); ?>">
                        <input type="radio" name="toilet" value="20">20万円
                    </div>
                    <div class="img-select">
                        <img src="<?php echo e(asset('storage/image/toilet3.jpg')); ?>">
            ...
            <div class="bath cost-content">
                ...
                <div class="cost-select">
                    ...
                    <div class="img-select">
                        <img src="<?php echo e(asset('storage/image/bath1.jpg')); ?>">
                        <input type="radio" name="bath" value="15">50万円
                    </div>
                    <div class="img-select">
                        <img src="<?php echo e(asset('storage/image/bath2.jpg')); ?>">
                        <input type="radio" name="bath" value="20">80万円
                    </div>
                    <div class="img-select">
                        <img src="<?php echo e(asset('storage/image/bath3.jpg')); ?>">
            ...
            <div class="kitchen cost-content">
                ...
                <div class="cost-select">
                    ...
                    <div class="img-select">
                        <img src="<?php echo e(asset('storage/image/kitchen1.jpg')); ?>">
                        <input type="radio" name="kitchen" value="15">30万円
                    </div>
                    <div class="img-select">
                        <img src="<?php echo e(asset('storage/image/kitchen2.jpg')); ?>">
                        <input type="radio" name="kitchen" value="20">70万円
                    </div>
                    <div class="img-select">
                        <img src="<?php echo e(asset('storage/image/kitchen3.jpg')); ?>">
            ...
            <div class="floor cost-content">
                ...
                <div class="cost-select">
                    ...
                    <div class="img-select">
                        <img src="<?php echo e(asset('storage/image/floor1.jpg')); ?>">
                        <input type="radio" name="floor" value="15">10万円
                    </div>
                    <div class="img-select">
                        <img src="<?php echo e(asset('storage/image/floor2.jpg')); ?>">
                        <input type="radio" name="floor" value="20">40万円
                    </div>
                    <div class="img-select">
                        <img src="<?php echo e(asset('storage/image/floor3.jpg')); ?>">
            ...
            <div class="pillar cost-content">
                ...
                <div class="cost-select">
                    ...
                    <div class="img-select">
                        <img src="<?php echo e(asset('storage/image/pillar1.png')); ?>">
                        <input type="radio" name="pillar" value="15">10万円
                    </div>
                    <div class="img-select">
                        <img src="<?php echo e(asset('storage/image/pillar2.jpg')); ?>">
                        <input type="radio" name="pillar" value="20">50万円
                    </div>
                    <div class="img-select">
                        <img src="<?php echo e(asset('storage/image/pillar3.jpg')); ?>">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/sample/resources/views/cost.blade.php ENDPATH**/ ?>